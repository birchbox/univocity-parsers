...
public class AnnotationHelper {
        ...
        try {
            ...
            if (annType == NullString.class) {
                ...
                if (conversion != null) {
                    ...
                    if (options.length > 0) {
                        if (conversion instanceof FormattedConversion) {
                            ...
                            throw new IllegalArgumentException("Options '" + Arrays.toString(options) + "' not supported by conversion of type '" + conversion.getClass() + "'. It must implement " + FormattedConversion.class);
                        }
                    }
                    return conversion;
                }
                ...
                try {
                    ...
                    throw new IllegalArgumentException("Could not find a public constructor with a String[] parameter in custom conversion class '" + conversionClass.getSimpleName() + "' (" + conversionClass.getName() + ")", e);
                } catch (Exception e) {
                    throw new IllegalArgumentException("Unexpected error instantiating custom conversion class '" + conversionClass.getSimpleName() + "' (" + conversionClass.getName() + ")", e);
                }
            }
            return null;
            ...
            throw new IllegalArgumentException("Unexpected error identifying conversions to apply over field " + field.getName() + " of class " + field.getDeclaringClass().getName(), ex);
        }
    }
            ...
            for (PropertyDescriptor property : beanInfo.getPropertyDescriptors()) {
                ...
                if (property.getName().equals("decimalFormatSymbols")) {
                    ...
                    try {
                        ...
                        throw new IllegalArgumentException("Error trying to configure decimal symbols  of formatter '" + formatter.getClass() + ".", ex);
                    }
                }
            }
    ...
    private static void invokeSetter(Object formatter, PropertyDescriptor property, String value) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Error setting property '" + property.getName() + "' of formatter '" + formatter.getClass() + ", with '" + parameterValue + "' (converted from '" + value + "')", e);
        }
    }
